...
import { Swiper as SwiperType } from "swiper"; // ✅ Typeni import qilyapmiz
import "swiper/swiper-bundle.css";
import { useState } from "react";

const Img1 = () => {
  const [thumbsSwiper, setThumbsSwiper] = useState<SwiperType | null>(null); // ✅ Typeni aniq belgiladik
        ...
        >
          <SwiperSlide>
            <img
              ...
              src="https://kinoplan24.ru/uploads/hall_info/8211/hall_info/61724e1d4b00001600318219/big-1634881097.jpg"
              alt="Rasm 1"
            />
          </SwiperSlide>
          <SwiperSlide>
            <img
              className="w-full h-[700px]"
              src="https://kinoplan24.ru/uploads/hall_info/8211/hall_info/61724e1d4b00001600318219/big-1634881061.jpg"
              alt="Rasm 2"
            />
          </SwiperSlide>
          <SwiperSlide>
          ...
          >
            <SwiperSlide>
              <img
                ...
                src="https://kinoplan24.ru/uploads/hall_info/8211/hall_info/61724e1d4b00001600318219/big-1634881097.jpg"
                alt="Rasm 1"
                onClick={() => thumbsSwiper?.slideTo(0)} // ✅ slideTo ishlatildi
              />
            </SwiperSlide>
            <SwiperSlide>
              <img
