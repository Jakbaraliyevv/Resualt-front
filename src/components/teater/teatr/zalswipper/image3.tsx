...
import { Swiper as SwiperType } from "swiper"; // ✅ SwiperType ni import qilamiz
import "swiper/swiper-bundle.css";
import { useState } from "react";

const Img3 = () => {
  const [thumbsSwiper, setThumbsSwiper] = useState<SwiperType | null>(null); // ✅ Type aniqlangan
          ...
          >
            <SwiperSlide>
              <img
                ...
                src="https://kinoplan24.ru/uploads/hall_info/8211/hall_info/6149813e4a0000276b5d08ef/big-1632207166.jpg"
                alt="Rasm 1"
                onClick={() => thumbsSwiper?.slideTo(0)} // ✅ slideTo ishlatilmoqda
              />
            </SwiperSlide>
            <SwiperSlide>
              <img
